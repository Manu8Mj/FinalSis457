...
using FinalSis457Mavp.Models;
using SinalSis457Mavp.Controllers;

namespace FinalSis457Mavp.Controllers
{
    [Authorize]
    public class SerieController : Controller
    {
        private readonly FinalSiss457mavpContext _context;

        public SerieController(FinalSiss457mavpContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
            ...
            return _context.Series != null ?
              ...
              Problem("Entity set 'FinalSis457MavpContext.Productos'  is null.");
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'FinalSiss457mavpContext.Serie'  is null.");
            }
            var serie = await _context.Series.FindAsync(id);
            if (serie != null)
            {
